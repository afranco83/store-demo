...
- **Peso de dependencias**: antes de añadir una dependencia nueva se comprueba su peso (Bundlephobia/Import Cost); `@next/bundle-analyzer` está disponible para consultarse en cualquier momento que una dependencia se sienta pesada, no solo en la revisión final de Fase 8 (`ROADMAP.md`).
