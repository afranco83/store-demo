...
Design system del monorepo, Atomic Design (`AGENTS.md §1.2`): `atoms/` (Button, Input, Select, Textarea, Badge, PriceTag, Spinner, Typography, Icon, VersionBadge), `molecules/` (ProductCard, ProductGrid, CartLineItem, ConfirmDialog, EmptyState, OrderSummaryCard, QuantitySelector, Table, WizardSteps), `organisms/` (CartDrawer, Navbar, UserMenu).
