...
- `base.json`: `strict: true` y el resto de flags estrictos (`§Versiones` del canon), sin JSX ni nada específico de framework — usado por paquetes puramente TS (`shared-types`, `api-client`, `core`).
