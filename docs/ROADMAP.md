...
- [ ] Decisión y, si procede, despliegue de demo pública (Vercel) — **decisión tomada y migración de código completada (2026-07-12), despliegue real pendiente de pasos manuales del usuario** (aprovisionar Turso, crear los 3 proyectos en Vercel — ver adenda más abajo)
