...
| Documentación | Storybook (+ addon-a11y, addon-interactions) | Documentación viva del design system — también es el registro visual del proyecto, ya que no hay diseños previos en Figma |
